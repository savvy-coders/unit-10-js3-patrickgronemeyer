...
// Note: You can test your outputs by running each function with appropriate arguments inside of a console.log() statement. For instance:
...
// Then this is how you can test it:
// console.log(addStuff(5,9));
// Good luck!
